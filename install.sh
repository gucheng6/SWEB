...
wget -N --no-check-certificate https://raw.githubusercontent.com/gucheng6/shadowsocks_install/master/shadowsocksR.sh
...
#Install SWEB
cd /usr/local/
git clone https://github.com/gucheng6/SWEB
...
wget -N --no-check-certificate -O /usr/local/bin/sweb https://raw.githubusercontent.com/gucheng6/SWEB/master/sweb
